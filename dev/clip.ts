...
export function TerrainClipPlan(
    t: Cesium.Viewer,
    i: {
        height: number,
        splitNum: number,
...
TerrainClipPlan.prototype.updateData = function (e: Array<Cesium.Cartesian3>
) {
    this.clear();
    let t = [],
        i = e.length;
...
TerrainClipPlan.prototype._prepareWell = function (e: Array<Cesium.Cartesian3>
) {
    var t = this.splitNum,
        i = e.length;
    if (0 != i) {
...
TerrainClipPlan.prototype._createWell = function (e) {
    if (Boolean(this.viewer.terrainProvider._layers)) {
        ...
        var promise = Cesium.sampleTerrainMostDetailed(this.viewer.terrainProvider, e.lerp_pos);
